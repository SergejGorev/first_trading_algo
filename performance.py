...
def create_sharpe_ratio(returns, periods=252):
    '''
    Creates the Sharpe ratio for the strategy, based on a benchmark of zero (i.e. no risk-free rate information)
...
def create_drawdowns(pnl):
    '''
    Calculate the largest peak-to-through drawdown of the PnL curve as well as the duration of the drawdown.
